...
export const siteRegistry: SiteEntry[] = [
  ...
  },
  {
    ...
    visibility: 'public',
    status: 'live',
    label: 'Blog alias → Writing',
    note: 'Worker 302 → alexander.xin/writing/; not a separate site; Ghost retired; author via Git',
    labels: {
      'zh-CN': '博客入口（写作）',
      'zh-TW': '部落格入口（寫作）',
      'en-GB': 'Blog entry (writing)',
      fr: 'Entrée blog (écrits)',
      ru: 'Вход в блог (writing)',
    },
    descriptions: {
      'zh-CN': '正式阅读在 /writing；blog 子域仅为入口别名并 302 到写作列表。',
      'zh-TW': '正式閱讀在 /writing；blog 子域僅為入口別名並 302 到寫作列表。',
      'en-GB': 'Canonical reading is /writing; blog subdomain is an entry alias with a 302.',
      fr: 'Lecture canonique sur /writing ; le sous-domaine blog n’est qu’un alias 302.',
      ru: 'Каноническое чтение — /writing; поддомен blog — лишь вход с 302.',
    },
  },
  {
    id: 'about-alias',
