...
export const siteRegistry: SiteEntry[] = [
  ...
  },
  {
    ...
    status: 'live',
    label: 'Blog → Writing',
    note: 'Worker 302 → alexander.xin/writing/; Ghost retired; author via Git',
    labels: {
      'zh-CN': '博客（写作）',
      'zh-TW': '部落格（寫作）',
      'en-GB': 'Blog (writing)',
    ...
    descriptions: {
      'zh-CN': '博客即 /writing；blog 子域公开重定向到写作列表。',
      'zh-TW': '部落格即 /writing；blog 子域公開重定向到寫作列表。',
      'en-GB': 'Blog is /writing; blog subdomain redirects to the writing index.',
      fr: 'Le blog est /writing ; le sous-domaine redirige vers la liste.',
      ru: 'Блог = /writing; поддомен blog ведёт к списку статей.',
    },
  },
  {
    id: 'about-alias',
