...
export const siteRegistry: SiteEntry[] = [
  ...
  },
  {
    ...
    status: 'live',
    label: 'Site help',
    note: 'Visitor help UI; API at /api/help (Worker site-help, optional OmniRoute)',
    labels: {
      'zh-CN': '站内帮助',
      'zh-TW': '站內幫助',
      'en-GB': 'Site help',
    ...
    descriptions: {
      'zh-CN': '基于公开站群资料的导览问答（OpenAI Help 风格精简版）。',
      'zh-TW': '基於公開站群資料的導覽問答。',
      'en-GB': 'Guided Q&A from public fleet docs (compact help-desk style).',
      fr: 'Q&R guidée à partir des docs publics de la flotte.',
      ru: 'Вопросы по публичным документам флота.',
    },
  },
  {
    id: 'changelog',
