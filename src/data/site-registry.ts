...
export const siteRegistry: SiteEntry[] = [
  ...
  },
  {
    ...
    status: 'live',
    label: 'Tool Hub',
    note: 'it-tools behind Tunnel; Bot Challenge may appear',
    labels: {
      'zh-CN': '工具合集',
      'zh-TW': '工具合集',
      'en-GB': 'Tool hub',
    ...
    descriptions: {
      'zh-CN': '服务器上的 IT-Tools 合集。',
      'zh-TW': '伺服器上的 IT-Tools 合集。',
      'en-GB': 'IT-Tools collection on the VPS.',
      fr: 'Collection IT-Tools sur le VPS.',
      ru: 'Коллекция IT-Tools на VPS.',
    },
  },
  {
    id: 'paste',
  ...
  },
  {
    ...
    descriptions: {
      'zh-CN': '公开短链跳转（Shlink）。',
      'zh-TW': '公開短鏈跳轉（Shlink）。',
      'en-GB': 'Public short-link redirects (Shlink).',
      fr: 'Redirections de liens courts (Shlink).',
      ru: 'Публичные короткие ссылки (Shlink).',
    },
  },
  {
    id: 'time-api',
  ...
  },
  {
    ...
    status: 'live',
    label: 'Pocket ID',
    note: 'Passkey OIDC IdP; no Access in front (is the IdP)',
    labels: {
      'zh-CN': '身份（Pocket ID）',
      'zh-TW': '身份（Pocket ID）',
  ...
  {
    id: 'shlink-admin',
    url: 'https://shlink.alexander.xin',
    category: 'ops',
    host: 'server-tunnel',
    visibility: 'private',
    status: 'live',
    label: 'Shlink admin',
    access: true,
    note: 'Cloudflare Access + Shlink API key',
    labels: {
      'zh-CN': '短链管理',
      'zh-TW': '短鏈管理',
      'en-GB': 'Short-link admin',
      fr: 'Admin liens courts',
      ru: 'Админка коротких ссылок',
    },
    descriptions: {
      'zh-CN': 'Shlink 管理端（API Key）。',
      'zh-TW': 'Shlink 管理端（API Key）。',
      'en-GB': 'Shlink management UI (API key).',
      fr: 'UI Shlink (clé API).',
      ru: 'Админка Shlink (API key).',
    },
  },
  {
    id: 'ops',
  ...
  },
  {
    ...
    status: 'planned',
    label: 'Blog → Writing',
    note: 'Ghost retired; prefer Astro writing as blog (no Ghost restore). Wire subdomain when approved.',
    labels: {
      'zh-CN': '博客（写作）',
      'zh-TW': '部落格（寫作）',
      'en-GB': 'Blog (writing)',
    ...
    descriptions: {
      'zh-CN': '计划以站点 /writing 为博客；不恢复 Ghost。',
      'zh-TW': '計畫以站點 /writing 為部落格；不恢復 Ghost。',
      'en-GB': 'Plan: site /writing as the blog; Ghost will not be restored.',
      fr: 'Prévu : /writing comme blog ; pas de restauration Ghost.',
      ru: 'План: /writing как блог; Ghost не восстанавливаем.',
    },
  },
  {
    id: 'about-alias',
