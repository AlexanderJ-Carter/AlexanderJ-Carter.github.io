  ...
  'zh-CN': {
    ...
    events: [
      ...
      },
      {
        ...
        title: '公开更新日志页',
        description:
          '新增 /changelog，五种语言可读，构建时同步仓库 CHANGELOG；导航与工具索引一并接入。',
        icon: '',
        color: '',
        tags: ['Docs', 'i18n', '维护'],
      },
      {
        ...
        title: '摄影编辑室焕新',
        description:
          '以真实影像为第一印象，统一字体与页眉页脚，收敛装饰动效；首页与内容页按“一件事一节”重排，并预留广告与验证开关。',
        icon: '',
        color: '',
        tags: ['设计系统', 'Astro', '体验'],
      },
  ...
  'zh-TW': {
    ...
    events: [
      ...
      },
      {
        ...
        title: '公開更新日誌頁',
        description:
          '新增 /changelog，五種語言可讀，建置時同步倉庫 CHANGELOG；導航與工具索引一併接入。',
        icon: '',
        color: '',
        tags: ['Docs', 'i18n', '維護'],
      },
      {
        ...
        title: '攝影編輯室煥新',
        description:
          '以真實影像為第一印象，統一字體與頁眉頁腳，收斂裝飾動效；首頁與內容頁按「一件事一節」重排。',
        icon: '',
        color: '',
        tags: ['設計系統', 'Astro', '體驗'],
      },
  ...
  'en-GB': {
    ...
    events: [
      ...
      },
      {
        ...
        description:
          'Added /changelog in five locales, synced from the repo CHANGELOG at build time; linked from nav and tools index.',
        icon: '',
        color: '',
        tags: ['Docs', 'i18n', 'Maintenance'],
      },
      {
        year: 2026,
        title: 'Editorial photography refresh',
        description:
          'Real photographs lead the first impression; type, header and footer unify; decorative motion is quieted; pages follow one job per section.',
        icon: '',
        color: '',
        tags: ['Design system', 'Astro', 'UX'],
      },
      {
        year: 2025,
  ...
  fr: {
    ...
    events: [
      ...
      },
      {
        ...
        description:
          'Page /changelog en cinq langues, synchronisée avec le CHANGELOG du dépôt ; liens depuis la nav et l’index outils.',
        icon: '',
        color: '',
        tags: ['Docs', 'i18n', 'Maintenance'],
      },
      {
        ...
        description:
          'La photo réelle mène la première impression ; typo, en-tête et pied unifiés ; motion plus calme ; une intention par section.',
        icon: '',
        color: '',
        tags: ['Design system', 'Astro', 'UX'],
      },
  ...
  ru: {
    ...
    events: [
      ...
      },
      {
        ...
        description:
          'Страница /changelog на пяти языках, синхронизируется с CHANGELOG при сборке; ссылки из навигации и индекса инструментов.',
        icon: '',
        color: '',
        tags: ['Docs', 'i18n', 'Сопровождение'],
      },
      {
        year: 2026,
        title: 'Редакционное обновление',
        description:
          'Реальные фотографии ведут первый экран; шрифты, шапка и подвал едины; декорации тише; у каждой секции одна задача.',
        icon: '',
        color: '',
        tags: ['Дизайн-система', 'Astro', 'UX'],
      },
      {
        year: 2025,
