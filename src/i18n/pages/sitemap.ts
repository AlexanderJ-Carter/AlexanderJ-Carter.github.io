    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          ...
          { name: '站内帮助', path: '/help', desc: '公开资料导览问答' },
          { name: '更新日志', path: '/changelog', desc: '版本与重要改动' },
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          ...
          { name: '站內幫助', path: '/help', desc: '公開資料導覽問答' },
          { name: '更新日誌', path: '/changelog', desc: '版本與重要改動' },
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          ...
          { name: 'Site help', path: '/help', desc: 'Public-doc Q&A' },
          { name: 'Changelog', path: '/changelog', desc: 'Version history' },
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          ...
          { name: 'Aide', path: '/help', desc: 'Q&R docs publics' },
          {
            name: 'Journal',
            path: '/changelog',
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          ...
          { name: 'Справка', path: '/help', desc: 'Q&A по публичным docs' },
          { name: 'Изменения', path: '/changelog', desc: 'История версий' },
